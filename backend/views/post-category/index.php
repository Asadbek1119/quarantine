...
/* @var $searchModel common\models\search\PostCategorySearch */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'attribute' => 'status',
                'format' => 'raw',
                'filter' => PostCategory::getStatusFilter(),
                'value' => static function (PostCategory $model) {
                    if ($model->status == PostCategory::STATUS_ACTIVE) {
                        return '<i class="badge badge-success">Faol</i>';
                    }
                    if ($model->status == PostCategory::STATUS_INACTIVE) {
